...
export function TimesheetPanel({
  ...
  return (
    <div data-timesheet-panel className={`relative absolute inset-y-3 right-3 z-20 flex flex-col overflow-hidden rounded-2xl border border-stone-200/80 bg-white shadow-xl shadow-stone-300/30 transition-[width] duration-300 ease-out ${generating ? 'timesheet-generating ' : ''}${expandedEntry ? 'w-[min(68vw,950px)]' : 'w-[calc(100%-12px)]'}`}>
      {/* Header */}
